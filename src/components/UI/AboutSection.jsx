...
import aboutImg from "../../assets/all-images/cars-img/mahindra-thar-roxx.webp";
        ...
        <Row>
          <Col lg="6" md="6">
            <div className="about__section-content">
              ...
              <h2 className="section__title mb-4">Cental <span className="text-danger">About</span></h2>
